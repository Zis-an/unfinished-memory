        ...
        <div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-md-5 mb-xl-10">
                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #F1416C;background-image:url('/metronic8/demo13/assets/media/patterns/vector-1.png')">
                    <div class="card-header pt-5">
                        <div class="card-title d-flex flex-column">
                            <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{$totalImage}}</span>
                            <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Total Image</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-md-5 mb-xl-10">
                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #F1416C;background-image:url('/metronic8/demo13/assets/media/patterns/vector-1.png')">
                    <div class="card-header pt-5">
                        <div class="card-title d-flex flex-column">
                            <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{$totalLine}}</span>
                            <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Total Line</span>
                        </div>
                    </div>
                </div>
            </div>
