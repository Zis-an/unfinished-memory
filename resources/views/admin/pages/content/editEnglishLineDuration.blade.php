                                    ...
                                    <div class="col-md-5">
                                        <div class="row">
                                            <div class="col-md-6 fv-row">
                                                ...
                                                <input type="text" name="start_time[]" class="form-control form-control-solid" value="{{ $contentEnglish->start_time }}"  placeholder="00:00"/>
                                            </div>
                                            <div class="col-md-6 fv-row">
                                                <label class="d-flex align-items-center fs-6 fw-semibold required">End Time</label>
                                                <input type="text" name="end_time[]" class="form-control form-control-solid" value="{{ $contentEnglish->end_time }}"  placeholder="00:00"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
