...
@section('admin_content')
                ...
                <div class="card-body pt-0">
                    @foreach($contents as $key=>$contentEnglish)
                        <div class="modal-body pt-0 pb-3">
                            <form action="{{route('update.content.english')}}" method="POST" class="form">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-12 fv-row">
                                    ...
                                    <textarea class="form-control form-control-solid" rows="2" name="line[]" placeholder="Type Target Details">{{ $contentEnglish->line }}</textarea>
                                </div>
                        </div>
                    @endforeach
    ...
    <script>
        ...
        @if(session('success') && request()->routeIs('update.content.english'))
        Swal.fire(
            'Success!',
